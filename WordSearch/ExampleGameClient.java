...
public class ExampleGameClient {
   ...
   public static void main(String[] args) {
      WordSearchGame game = new WordSearchClass();
      String file = "CSW12.txt";
      game.loadLexicon(file);
      WordSearchClass thing = new WordSearchClass();
      //System.out.println(thing.gridToString());
