...
public final class Selector {
   ...
   public static int kmin(int[] a, int k) {
      ...
      Arrays.sort(b); // s orted list with duplicates.
      // now to find distinct values.
   ...
   public static int kmax(int[] a, int k) {
      ...
      Arrays.sort(b); // sorted list with duplicates.
      // now to find distinct values.
      int distinctValues = 1;
      int mark = 0;
 ...
 /**
    ...
    *@return int which is an integer.
    *@throws IllegalArgumentException is the exception.
    */
   ...
   public static int ceiling(int[] a, int key) {
      ...
      for (int i = 0; i < a.length; i++) {
         if (key <= a[i]) {
            int[] ceilingArray = 
               Arrays.copyOf(newArray, newArray.length + 1);
